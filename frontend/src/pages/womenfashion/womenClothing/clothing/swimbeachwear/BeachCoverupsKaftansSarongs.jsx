...
const BeachCoverupsKaftansSarongs = () => {
  return (
    <div>
     ...
     <div className='flex flex-col bg-white md:flex-row gap-2 p-2'>
        <div className="w-64 flex flex-col gap-2">
           ...
           <Link to="/women/clothing/sleep-loungewear" className="flex items-center  text-sm">
             <IoIosArrowBack /> Swim & Beachwear
           </Link>
           <h1 className="font-semibold text-sm px-4">Beach Cover-ups, Kaftans & Sarongs</h1>
        </div>
...
export default BeachCoverupsKaftansSarongs