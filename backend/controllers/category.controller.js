...
export const deleteCategory = catchAsync(async(req,res,next)=>{
    ...
    const hasChildern = await Category.findOne({parent: req.params.id});
    if (hasChildren) {
...
export const getCategoriesByType = catchAsync(async(req,res,next)=>{
    ...
    const validTypes = ["fashion","electronics","home","beauty","sports","books","automotive","grocery","toys","other"];
