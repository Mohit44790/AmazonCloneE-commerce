...
const womenMenu = {
  ...
  promos: [
    { label: "Women's Clothing", cta: 'Explore Store', link: '/women/clothing', image: 'https://m.media-amazon.com/images/G/31/img18/Fashion/September18/Flyouts/Women.jpg' },
    { label: 'Silver Jewellery', cta: 'Explore Store', link: '/women/jewellery/silver-jewellery', image: 'https://m.media-amazon.com/images/G/31/img19/Jew/Feb/380-500.jpg' },
    { label: 'MAX | Just Launched', cta: 'Explore Store', link: '/brands/max', image: 'https://m.media-amazon.com/images/G/31/img19/Fashion/WA19/MAX/FLY_OUT/Sub-Nav-Women-2._CB439603748_.jpg' },
  ],
}
...
const menMenu = {
  ...
  promos: [
    { label: "Men's Clothing", cta: 'Explore Store', link: '/men/clothing', image: 'https://m.media-amazon.com/images/G/31/img18/Fashion/September18/Flyouts/Men.jpg' },
    { label: 'Running Shoes', cta: 'See More', link: '/men/shoes/sports-shoes', image: 'https://m.media-amazon.com/images/G/31/img18/Fashion/September18/Flyouts/Running-Shoes.jpg' },
    { label: 'MAX | Just Launched', cta: 'Explore Store', link: '/brands/max', image: 'https://m.media-amazon.com/images/G/31/img19/Fashion/WA19/MAX/FLY_OUT/Sub-Nav-men-2._CB439603748_.jpg' },
  ],
}
...
const kidsMenu = {
  ...
  promos: [
    { label: "Kids' Clothing", cta: 'Explore Store', link: '/kids/clothing', image: 'https://m.media-amazon.com/images/G/31/img19/Fashion/WA19/MAX/FLY_OUT/Sub-Nav-Kids._CB1198675309_.jpg' },
    { label: 'School Essentials', cta: 'See More', link: '/kids/school-essentials', image: 'https://m.media-amazon.com/images/G/31/img19/Apparel/KA/GW/Sub-Nav/2._CB469401627_.jpg' },
    { label: 'Girls', cta: 'See More', link: '/kids/school-essentials', image: 'https://m.media-amazon.com/images/G/31/img19/Apparel/KA/GW/Sub-Nav/girls._CB469401626_.jpg' },
  ],
}
...
const bagsMenu = {
  ...
  promos: [
    { label: 'Bags & Luggage', cta: 'Explore Store', link: '/bags-luggage', image: 'https://m.media-amazon.com/images/G/31/img19/Fashion/DesktopSubnav/Updated/HB.jpg' },
    { label: 'Travel Essentials', cta: 'See More', link: '/bags-luggage/travel-essentials', image: 'https://m.media-amazon.com/images/G/31/img19/Fashion/DesktopSubnav/Updated/BP.jpg' },
    { label: 'Travel Essentials', cta: 'See More', link: '/bags-luggage/travel-essentials', image: 'https://m.media-amazon.com/images/G/31/img19/Fashion/DesktopSubnav/Updated/BWL.jpg' },
  ],
}
...
const sportswearMenu = {
  ...
  promos: [
    { label: "Men's sportswear", cta: 'See More', link: '/sportswear/men', image: 'https://m.media-amazon.com/images/G/31/img18/Fashion/September18/Flyouts/Sports_M._CB483839267_.jpg' },
    { label: "Women's sportswear", cta: 'See More', link: '/sportswear/women', image: 'https://m.media-amazon.com/images/G/31/img18/Fashion/September18/Flyouts/Sports_W._CB483839267_.jpg' },
  ],
}
...
const salesMenu = {
  columns: [],
  grid: [
    { label: 'Clothing', sub: '40% - 70% off', link: '/deals/clothing', image: 'https://m.media-amazon.com/images/G/31/img19/Fashion/DesktopSubnav/Updated/CL.jpg' },
          ...
          <a key={p.label} href={p.link} className="text-center block w-32 group">
            <div className="overflow-hidden bg-gray-100">
              <img
                src={p.image}
                alt={p.label}
                className="w-32 h-72 object-cover group-hover:scale-105 transition-transform duration-200"
              />
            </div>
  ...
  return (
    <div className="w-full font-sans bg-white relative">
      ...
      <div className="flex items-center px-6 py-2 border-b border-gray-200">
        ...
        <nav className="flex gap-28" onMouseLeave={scheduleClose}>
          {NAV_TABS.map((tab) => (
